    ...
    <div class="wrapper">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('homecontent.banner') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Banner</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('homecontent.watch') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Đồng hồ</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('homecontent.accessory') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Phụ kiện</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('homecontent.technology') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Tin công nghệ</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('homecontent.like') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Có thể bạn thích</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('homecontent.icon') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Header nav icon</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('homecontent.slide') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>slide</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('homecontent.telephone') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
        ...
        <div style="margin-left: 250px;">
                ...
                <div class="item mb-5">
                    <div class="row">
                        ...
                        <div class="col-6 content mt-5 mb-5">
                            ...
                            <form class="w-100" action="{{ route('homeproduct.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div>
                                    <label><strong>image_product</strong></label>
                                    <input type="file" required name="file_image_product">
                                </div>

                                <div>
                                    <label><strong>image_sale</strong></label>
                                    <input type="file" required name="file_image_sale">
                                </div>

                                <div>
                                    <label><strong>price product</strong></label>
                                    <input type="text" name="price" placeholder="price product*" require>
                                </div>

                                <div>
                                    <label><strong>price product sale</strong></label>
                                    <input type="text" name="sale" placeholder="price product sale*" value="{{ old('sale') }}" require>
                                </div>

                                <div>
                                    <label><strong>image sale price</strong></label>
                                    <input type="text" name="image_sale_price" placeholder="image sale price*" value="{{ old('image_sale_price') }}" require>
                                </div>

                                <div>
                                    <label><strong>name product</strong></label>
                                    <input type="text" name="name_product" placeholder="name product*" value="{{ old('name_product') }}" require>
                                </div>

                                <div>
                                    <label><strong>discount</strong></label>
                                    <input type="text" name="discount" placeholder="discount*" value="{{ old('discount') }}" require>
                                </div>

                                <div>
                                    <label><strong>Other</strong></label>
                                    <input type="text" name="other" placeholder="other*" value="{{ old('other') }}" require>
                                </div>
            ...
            <table class="table table-bodered table-hover table-striped">
                ...
                <tr>
                    <td>{{ $no++ }}</td>
                    <td><img src="{{ asset('images/'.$data->image_product) }}" style="height: 70px; width: 100px;"></td>
                    <td><img src="{{ asset('images/'.$data->image_sale) }}" style="height: 70px; width: 100px;"></td>
                    <td>{{ $data->price }}</td>
                    <td>{{ $data->sale}}</td>
                    <td>{{ $data->image_sale_price}}</td>
                    <td>{{ $data->name_product }}</td>
                    <td>{{ $data->discount }}</td>
                    <td>{{ $data->other}}</td>
                    <td>
                        <a href="" class="btn btn-info">Edit</a>
                        <form class="d-inline" action="{{ route('home_delete', $data->home_product_id) }}" method="POST" onsubmit="return confirm('Delete?')">
                            @csrf
                            @method("DELETE")
            ...
            <p class="mt-5"><strong>Phone</strong></p>
            <!--header nav add phone -->
            <div id="phone" class="w3-modal resgiter">
                <div class="item mb-5">
                    <div class="row">
                        <div class="img col-4 d-flex justify-content-center align-items-center">
                            <img src="{{ asset('images/login-bg.png') }}" alt="logo" />
                        ...
                        <div class="col-6 content mt-5 mb-5">
                            ...
                            <form class="w-100" action="{{ route('phone.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" required name="phone2">
                                </div>

                                <div>
                                    <label><strong>phone col 3</strong></label>
                                    <input type="text" required name="phone3">
                                </div>

                                <div>
                                    <label><strong>price phone</strong></label>
                                    <input type="text" name="price" placeholder="price phone*" require>
                                </div>

                                <div>
                                    <label><strong>care phone</strong></label>
                                    <input type="text" name="care" require>
                                </div>

                                <div>
                                    <label><strong>image</strong></label>
                                    <input type="file" name="image_phone" require>
                                </div>
                        ...
                        <div class="col-1">
                            <button class="w-100 border border-0 mt-3 bg-white" style="color:red" onclick="document.getElementById('phone').style.display='none'"><strong>X</strong></button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form class="d-flex align-item-center mt-3 mb-3">
                <input class="w-25 border border-none outline-none" type="text" name="q" style="margin-right: 10px;">
                <button class="btn btn-info border border-0 p-2" style="margin-right: 10px;">Search</button>
                <a class="btn btn-success" onclick="document.getElementById('phone').style.display='block'">add phone</a>
            </form>
            <table class="table table-bodered table-hover table-striped mt-3 mb-5">
                ...
                <tr>
                    ...
                    <td>{{ $phones->price }}</td>
                    <td>{{ $phones->care }}</td>
                    <td><img src="{{ asset('images/'.$phones->image) }}" style="height: 70px; width: 100px;"></td>
                    <td>
                        <a href="" class="btn btn-info">Edit</a>
                        <form class="d-inline" action="{{ route('phone_delete', $phones->phone_id) }}" method="POST" onsubmit="return confirm('Delete?')">
                            @csrf
                            @method("DELETE")
                            <button class="btn btn-success">Delete</button>
                        </form>
