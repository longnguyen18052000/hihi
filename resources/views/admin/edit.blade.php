            ...
            <div id="edit" class=" resgiter">
                <div class="item mb-5">
                    <div class="row">
                        ...
                        <div class="col-1"></div>
                        <div class="col-7 content mt-5 mb-5">
                            <h2><strong>Chỉnh sửa tài khoản</strong></h2>
                            <span>Chú ý các nội dung có dấu * bạn cần phải nhập</span>

                            <form action="{{ route('admin.update', $customer) }}" method="POST" class="w-100">
                                @csrf
                                @method('PUT')
                                <div>
                                    <label><strong>Tài khoản</strong></label>
                                    <input type="text" name="name" placeholder="Họ tên *" value=" {{ old('name, $customer->name') }}" require>
                                    @if($errors->any())
                                ...
                                <div>
                                    ...
                                    <input type="text" name="username" placeholder="Họ tên *" value="{{ old('username, $customer->username') }}" require>
                                    @if($errors->any())
                                ...
                                <div>
                                    ...
                                    <input type="date" name="date_of_birth" placeholder="Ngày tháng năm sinh" value="{{ old('date_of_birth, , $customer->date_of_birth') }}" require>
                                    @if($errors->any())
                                ...
                                <div>
                                    ...
                                    <input type="tel" name="phone" placeholder="Điện thoại *" value="{{ old('phone, $customer->phone') }}" require>
                                    @if($errors->any())
                                ...
                                <div>
                                    ...
                                    <input type="text" name="address" placeholder="Địa chỉ *" value="{{ old('address, $customer->address') }}" require>
                                    @if($errors->any())
                                ...
                                <div>
                                    ...
                                    <input type="text" name="city" placeholder="Chọn tỉnh/Thành phố" value="{{ old('city, $customer->city') }}" require>
                                    @if($errors->any())
                                ...
                                <div>
                                    ...
                                    <input type="text" name="district" placeholder="Chọn Quận/Huyện *" value="{{ old('district, $customer->district') }}" require>
                                    @if($errors->any())
