            ...
            <table class="table table-bodered table-hover table-striped">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="row">
                            <a class="btn btn-success" style="margin-right:10px" href="{{ route('admin.edit', $customer) }}">Edit</a>
                            <form method="POST" class="d-inline" action="{{ route('admin.destroy', $customer->user_id) }}" onsubmit="return confirm('Delete?')">
                                @csrf
                                @method('DELETE')
