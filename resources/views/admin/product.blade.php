            ...
            <div class="item mb-5">
                <div class="row">
                    ...
                    <div class="col-6 content mt-5 mb-5">
                        ...
                        <form class="w-100" action="{{ route('product.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div>
                                <label><strong>Tên sản phẩm</strong></label>
                                <input type="text" name="product_name" placeholder="product_name *" value=" {{ old('product_name') }}" require>
                                @if($errors->any())
                                @foreach($errors->get('product_name') as $err)
                            ...
                            <div>
                                ...
                                <input type="text" name="price" placeholder="price*" value="{{ old('price') }}" require>
                                @if($errors->any())
        ...
        <div id="edit" class="w3-modal resgiter">
            <div class="item mb-5">
                <div class="row">
                    ...
                    <div class="col-1"></div>
                    <div class="col-6 content mt-5 mb-5">
                        <h2><strong>Edit sản phẩm</strong></h2>
                        <span>Chú ý các nội dung có dấu * bạn cần phải nhập</span>
        ...
        <div style="margin-left:100px">
            ...
            <table class="table table-bodered table-hover table-striped">
                ...
                <tr>
                    ...
                    <td>{{ $data->price }}</td>
                    <td>
                        <img src="{{ asset('images/'.$data->images) }}" style="height: 70px; width: 100px;">
                    </td>
                    <td>
                        <a class="btn btn-info" onclick="document.getElementById('edit').style.display='block'">Edit</a>
                        <form class="d-inline" action="{{ route('product.delete', $data->product_id) }}" method="POST" onsubmit="return confirm('Delete?')">
                            @csrf
                            @method('DELETE')
